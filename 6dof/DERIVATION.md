...
$$
\mathbf{Q} = \text{diag}(\sigma_{ng}^2 \mathbf{I}_{3}, \sigma_{na}^2 \mathbf{I}_{3}, \sigma_{nbg}^2 \mathbf{I}_{3}, \sigma_{nba}^2 \mathbf{I}_{3})
$$
...
The **iterated** update repeats with the current $\mathbf{x}$ and $\mathbf{H}$ until $\|\delta\mathbf{x}_{i}\| < \epsilon_{i}$ (typical $\epsilon \sim 10^{-4}$) or max iterations (5–10).
